    ...
    <div className="container d-flex justify-content-center align-items-center vh-100 login-box">
      ...
      <span style={{"--i":0}}></span>
        ...
        <form className='p-3 col-sm-12 col-lg-12 col-md-12'>
          ...
          <CustomInput i_type="email" i_label="Email" id="email"></CustomInput>
          {/* <p style={{color:"white"}}>Please enter email id to get <br /> reset password mail</p> */}
          <div className='d-flex justify-content-center mt-2'>
            <button type="submit" style={{backgroundColor:"#0ef"}} className="adm-Forget w-100">Send Link</button>
          </div>
        </form>
      </div>
    </div>
